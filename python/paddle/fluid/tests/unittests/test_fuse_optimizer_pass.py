...
class TestFuseAdamOps(TestParallelExecutorBase):
    ...
    def _compare_fuse_all_reduce_ops(self,
        ...
        not_fuse_op_first_loss, not_fuse_op_last_loss = self.check_network_convergence(
            ...
            optimizer=optimizer,
            fetch=[
                "fc_2.b_0", "fc_2.b_0@GRAD", "fc_2.w_0", "fc_2.w_0@GRAD",
                "batch_norm_1.b_0", "batch_norm_1.w_0", "fc_1.b_0",
                "fc_1.b_0@GRAD", "fc_1.w_0", "fc_1.w_0@GRAD",
                "batch_norm_0.b_0", "batch_norm_0.w_0", "fc_0.b_0",
                "fc_0.b_0@GRAD", "fc_0.w_0", "fc_0.w_0@GRAD"
            ])
        fuse_op_first_loss, fuse_op_last_loss = self.check_network_convergence(
            ...
            optimizer=optimizer,
            fetch=[
                "fc_5.b_0", "fc_5.b_0@GRAD", "fc_5.w_0", "fc_5.w_0@GRAD",
                "batch_norm_3.b_0", "batch_norm_3.w_0", "fc_4.b_0",
                "fc_4.b_0@GRAD", "fc_4.w_0", "fc_4.w_0@GRAD",
                "batch_norm_2.b_0", "batch_norm_2.w_0", "fc_3.b_0",
                "fc_3.b_0@GRAD", "fc_3.w_0", "fc_3.w_0@GRAD"
            ])

...
def conv2d(input,
    ...
    * :math:`Out`: Output value, the shape of :math:`Out` and :math:`X` may be
    ...
    filter_size = utils.normalize_list(filter_size, 2, 'conv2d.filter_size')
    stride = utils.normalize_list(stride, 2, 'conv2d.stride')
    padding = utils.normalize_list(padding, 2, 'conv2d.padding')
...
def conv2d_transpose(input,
    ...
    * :math:`Out`: Output value, the shape of :math:`Out` and :math:`X` may be
    ...
    padding = utils.normalize_list(padding, 2, 'conv2d_transpose.padding')
    stride = utils.normalize_list(stride, 2, 'conv2d_transpose.stride')
    dilation = utils.normalize_list(dilation, 2, 'conv2d_transpose.dilation')
    ...
    if filter_size is None:
        ...
        filter_size = utils.normalize_list(filter_size, 2,

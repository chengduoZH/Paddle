...
// Channel* GetChannel(const platform::Place place, const size_t capacity,
//                  const size_t bytes_limit) {
//  static std::map<platform::Place, Channel*> buffering;
//
//  if (buffering.count(place)) {
//    buffering[place] = new Channel(capacity, bytes_limit);
//  }
